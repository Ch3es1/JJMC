...
public class SukunaSecondary implements Ability {

    @Override
    public String getName() { return "§d§lWorld Cutting Slash"; }

    @Override
    public String getId() { return "sukuna_secondary"; }
